...
pub const CLAUDE_SYSTEM_PROMPT: &str = concat!(
    ...
    "NEWLINES: use REAL newline characters inside file content strings. ",
    "Backslash-n is NOT an escape sequence in this format: writing \\n ",
    "produces the two literal characters backslash and n in the file, ",
    "corrupting the source. Multi-line strings with actual line breaks ",
    "are valid and required. ",
